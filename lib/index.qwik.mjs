import { componentQrl, inlinedQrl, _jsxSorted, _wrapProp } from "@builder.io/qwik";
var util;
(function(util2) {
...
const Insights = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  return /* @__PURE__ */ _jsxSorted("script", {
    ...
    "data-insights": _wrapProp(props, "publicApiKey")
  }, null, 3, "6Q_0");
...
function runQwikJsonDebug(window, document, debug) {
  const parseQwikJSON = () => {
    ...
    const derivedFns = document.querySelector('script[q\\:func="qwik/json"]')?.qFuncs || [];
...
function qwikJsonDebug(document, qwikJson, derivedFns) {
  ...
  function getNodeMap() {
    ...
    const walker = document.createTreeWalker(document.firstElementChild, NodeFilter.SHOW_COMMENT | NodeFilter.SHOW_ELEMENT);
