...
const InsightsError = /* @__PURE__ */ zod.z.object({
...
const InsightSymbol = /* @__PURE__ */ zod.z.object({
  symbol: zod.z.string(),
  route: zod.z.string(),
  delay: zod.z.number(),
  latency: zod.z.number(),
  timeline: zod.z.number(),
  interaction: zod.z.boolean()
});
const InsightsPayload = /* @__PURE__ */ zod.z.object({
  qVersion: zod.z.string(),
  manifestHash: zod.z.string(),
  publicApiKey: zod.z.string(),
  // we retain nullable for older clients
  previousSymbol: zod.z.string().optional().nullable(),
  symbols: zod.z.array(InsightSymbol)
});
InsightSymbol._type;
...
const json = `runQwikJsonDebug(window, document, qwikJsonDebug);
